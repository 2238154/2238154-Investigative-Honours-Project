...
# Gpower Actual power output using means: 0.8411089
...
# Includes 3 apriori alleles (association reported in literature): A03 (progression), C04 (progression), dqb1_03 (clearance)

# Other apriori alleles that were filtered out by our parameters:
# drb1_1 (clearance), drb1_11 (clearance), B27 (clearance)

apriori<- summarydat %>% filter(`Locus` == "hla_drb1" & `Allele` == "1"  | `Locus` == "hla_drb1" & `Allele` == "11"  | `Locus` == "hla_b" & `Allele` == "B27")
...
pheatmap(x, cluster_col = F, cluster_row = F, na_col="white",  border_color = NA, fontsize= 9, color.palette= "viridis",clustering_distance_rows = "correlation")

y <- x[c("dpa1_1","dpb1_4","dqa1_1","dqb1_2","dqb1_3","dqb1_5","dqb1_6","A01","A02","A03","A11","A24","B07","B08","B35","B44","C01","C03","C04","C07","hla_drb1_3","hla_drb1_4","hla_drb1_5","hla_drb1_7","hla_drb3_2","B27","hla_drb1_1","hla_drb1_11")]
y <- y[c("dpa1_1","dpb1_4","dqa1_1","dqb1_2","dqb1_3","dqb1_5","dqb1_6","A01","A02","A03","A11","A24","B07","B08","B35","B44","C01","C03","C04","C07","hla_drb1_3","hla_drb1_4","hla_drb1_5","hla_drb1_7","hla_drb3_2", "B27","hla_drb1_1","hla_drb1_11"),]
knitr::kable(y, caption = 'Correlations amongst alleles with an overall carrier frequency greater than 15% and apriori alleles')

y <- as.matrix(y)

row.names(y) <- c("DPA1_1", "DPB1_4", "DQA1_1", "DQB1_2", "DQB1_3", "DQB1_5", "DQB1_6", "A01", "A02", "A03", "A11", "A24", "B07", "B08", "B35", "B44", "C01", "C03", "C04", "C07", "DRB1_3", "DRB1_4", "DRB1_5", "DRB1_7", "DRB3_2", "B27", "DRB1_1", "DRB1_11")
colnames(y) <- c("DPA1_1", "DPB1_4", "DQA1_1", "DQB1_2", "DQB1_3", "DQB1_5", "DQB1_6", "A01", "A02", "A03", "A11", "A24", "B07", "B08", "B35", "B44", "C01", "C03", "C04", "C07", "DRB1_3", "DRB1_4", "DRB1_5", "DRB1_7", "DRB3_2", "B27", "DRB1_1", "DRB1_11")

y <- y[,c("A01", "A02", "A03", "A11", "A24", "B07", "B08", "B27", "B35", "B44", "C01", "C03", "C04", "C07","DPA1_1", "DPB1_4", "DQA1_1", "DQB1_2", "DQB1_3", "DQB1_5", "DQB1_6",  "DRB1_3", "DRB1_4", "DRB1_5", "DRB1_7", "DRB3_2","DRB1_1", "DRB1_11")]
y <- y[c("A01", "A02", "A03", "A11", "A24", "B07", "B08", "B27", "B35", "B44", "C01", "C03", "C04", "C07","DPA1_1", "DPB1_4", "DQA1_1", "DQB1_2", "DQB1_3", "DQB1_5", "DQB1_6",  "DRB1_3", "DRB1_4", "DRB1_5", "DRB1_7", "DRB3_2","DRB1_1", "DRB1_11"),]

pheatmap(y, cluster_col = F, cluster_row = F, na_col="white",  border_color = NA, fontsize= 9, color.palette= "viridis", clustering_distance_rows = "correlation")

# Significant associations (greater than 0.8): drb1_1 - dqb1_5, dqb1_2 - drb1_7
```
...
```{r, message=FALSE, warning=FALSE}
x10 <- x8[-c(1)]
varnames <- c("dpa1_1","dpb1_4","dqa1_1","dqb1_2","dqb1_3","dqb1_5","dqb1_6","A01","A02","A03","A11","A24","B07","B08","B35","B44","C01","C03","C04","C07","hla_drb1_3","hla_drb1_4","hla_drb1_5","hla_drb1_7","hla_drb3_2", "B27","hla_drb1_1","hla_drb1_11")
...
GLM <- GLM %>%  mutate_if(is.numeric, round, digits = 3)
GLM$Allele <- c("DPA1_1", "DPB1_4", "DQA1_1", "DQB1_2", "DQB1_3", "DQB1_5", "DQB1_6", "A01", "A02", "A03", "A11", "A24", "B07", "B08", "B35", "B44", "C01", "C03", "C04", "C07", "DRB1_3", "DRB1_4", "DRB1_5", "DRB1_7", "DRB3_2", "B27", "DRB1_1", "DRB1_11")
...
GLM2 <- GLM2 %>%  mutate_if(is.numeric, round, digits = 3)

GLM_filtered2 <- GLM2 %>% filter(p.value <= 0.25)
print(GLM_filtered2)

# CC_NCC p>0.25 so excluded from multivariate model
```

### Looking at other variables - Univariate analysis forest plot
```{r, message=FALSE, warning=FALSE}
...
print(vif)
# Generalized collinearity diagnostic Values are between 1 and 5 which indicates moderate correlation, but these are not severe enough to require their removal.
```
...
# 11 participants excluded due to incomplete data
```
...
blr_rsq_mcfadden(GLM_final)

# 16.4% variation explained
```
...
### Final GLM - Area under the ROC curve (AUC) - a measure of how well a parameter can distinguish between HCV outcomes (progression/clearance).
```{r, message=FALSE, warning=FALSE}
library(ROCR)
library(plotROC)
library(scales)
...
# AUC = 0.74 Acceptable discrimination, predicitons have a decent capability of distinguishing HCV outcome.
```